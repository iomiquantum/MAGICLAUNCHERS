...
# ATENCIÓN: este lanzador da a Codex acceso completo al usuario actual,
# sin sandbox y sin solicitudes de aprobación.
...
PROJECT_DIR=$(osascript -e 'POSIX path of (choose folder with prompt "Elige el proyecto para abrir con Codex (acceso total)")' 2>/dev/null)
...
exec tmux new-session -s "$SESSION_NAME" -c "$PROJECT_DIR" \
  "caffeinate -s codex --dangerously-bypass-approvals-and-sandbox --no-alt-screen"
